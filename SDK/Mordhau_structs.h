...
enum class EPlayFabRequestType : uint8_t
{
	...
	EPlayFabRequestType__GetSessionRewards = 18,
	EPlayFabRequestType__AbortSession = 19,
	EPlayFabRequestType__RegisterGameServer = 20,
	EPlayFabRequestType__RefreshGameServer = 21,
	EPlayFabRequestType__UpdateGameServer = 22,
	EPlayFabRequestType__StartSession = 23,
	EPlayFabRequestType__EndSession = 24,
	...
	EPlayFabRequestType__EPlayFabRequestType_MAX = 29
};
...
// ScriptStruct Mordhau.PlayFabSession
// 0x0060
struct FPlayFabSession
{
...
struct FFindServerSessionsFilter
{
	...
	int                                                MaxSlots;                                                 // 0x000C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                MaxPing;                                                  // 0x0010(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0014(0x0004) MISSED OFFSET
...
struct FReportMatchEndedPlayFabRequest : public FPlayFabRequest
{
	...
	int                                                PlayerCount;                                              // 0x0038(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                Duration;                                                 // 0x003C(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
struct FReportTimeLeftPlayFabRequest : public FPlayFabRequest
{
	...
	int                                                PlayerCount;                                              // 0x0028(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
	TArray<float>                                      TimeLeft;                                                 // 0x0030(0x0010) (ZeroConstructor)
};
...
{
	struct FSteamID                                    SteamID;                                                  // 0x0018(0x0008)
	EPlayFabRestriction                                Restriction;                                              // 0x0020(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
	int64_t                                            EndTimestamp;                                             // 0x0028(0x0008) (ZeroConstructor, IsPlainOldData)
};

// ScriptStruct Mordhau.EndSessionPlayFabRequest
// 0x0070 (0x0088 - 0x0018)
struct FEndSessionPlayFabRequest : public FPlayFabRequest
{
	struct FString                                     PlayerId;                                                 // 0x0018(0x0010) (ZeroConstructor)
	struct FPlayFabSession                             Session;                                                  // 0x0028(0x0060)
};

// ScriptStruct Mordhau.StartSessionPlayFabRequest
// 0x0070 (0x0088 - 0x0018)
struct FStartSessionPlayFabRequest : public FPlayFabRequest
{
	struct FString                                     PlayerId;                                                 // 0x0018(0x0010) (ZeroConstructor)
	struct FPlayFabSession                             Session;                                                  // 0x0028(0x0060)
};
...
{
	struct FString                                     ServerName;                                               // 0x0018(0x0010) (ZeroConstructor)
	struct FString                                     MapName;                                                  // 0x0028(0x0010) (ZeroConstructor)
	struct FString                                     GameMode;                                                 // 0x0038(0x0010) (ZeroConstructor)
	struct FString                                     RegionName;                                               // 0x0048(0x0010) (ZeroConstructor)
	int                                                BeaconListenPort;                                         // 0x0058(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x005C(0x0004) MISSED OFFSET
	struct FString                                     Mods;                                                     // 0x0060(0x0010) (ZeroConstructor)
	struct FString                                     Pings;                                                    // 0x0070(0x0010) (ZeroConstructor)
	struct FString                                     Location;                                                 // 0x0080(0x0010) (ZeroConstructor)
	struct FString                                     DockerHost;                                               // 0x0090(0x0010) (ZeroConstructor)
	struct FString                                     DockerServer;                                             // 0x00A0(0x0010) (ZeroConstructor)
};
...
{
	struct FString                                     PublicIP;                                                 // 0x00B0(0x0010) (ZeroConstructor)
};

// ScriptStruct Mordhau.AbortSessionPlayFabRequest
// 0x0020 (0x0038 - 0x0018)
struct FAbortSessionPlayFabRequest : public FPlayFabRequest
{
	struct FString                                     ServerId;                                                 // 0x0018(0x0010) (ZeroConstructor)
	struct FString                                     SessionId;                                                // 0x0028(0x0010) (ZeroConstructor)
};

// ScriptStruct Mordhau.GetSessionRewardsPlayFabRequest
// 0x0020 (0x0038 - 0x0018)
struct FGetSessionRewardsPlayFabRequest : public FPlayFabRequest
{
	struct FString                                     ServerId;                                                 // 0x0018(0x0010) (ZeroConstructor)
	struct FString                                     SessionId;                                                // 0x0028(0x0010) (ZeroConstructor)
};
...
{
	struct FString                                     LeaderboardName;                                          // 0x0018(0x0010) (ZeroConstructor)
};
...
{
	TArray<struct FString>                             ItemIds;                                                  // 0x0018(0x0010) (ZeroConstructor)
};
...
{
	struct FString                                     PlayerId;                                                 // 0x0018(0x0010) (ZeroConstructor)
	TMap<struct FString, struct FPlayFabStat>          Stats;                                                    // 0x0028(0x0050) (ZeroConstructor)
};
...
{
	struct FString                                     CustomId;                                                 // 0x0018(0x0010) (ZeroConstructor)
};
...
{
	struct FString                                     AuthTicket;                                               // 0x0018(0x0010) (ZeroConstructor)
};
...
struct FPlayFabPlayerData
{
	...
	TArray<struct FPlayFabSession>                     Sessions;                                                 // 0x0018(0x0010) (ZeroConstructor)
};
