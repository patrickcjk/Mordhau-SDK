...
// Function modio.CallbackProxy_CheckIfModsAreUpdated.CheckIfModsAreUpdated
// (Final, Native, Static, Public, HasOutParms, BlueprintCallable)
// Parameters:
// class UObject*                 WorldContext                   (Parm, ZeroConstructor, IsPlainOldData)
// TArray<int>                    ModIds                         (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
// class UCallbackProxy_CheckIfModsAreUpdated* ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

class UCallbackProxy_CheckIfModsAreUpdated* UCallbackProxy_CheckIfModsAreUpdated::STATIC_CheckIfModsAreUpdated(class UObject* WorldContext, TArray<int> ModIds)
{
	static auto fn = UObject::FindObject<UFunction>("Function modio.CallbackProxy_CheckIfModsAreUpdated.CheckIfModsAreUpdated");

	UCallbackProxy_CheckIfModsAreUpdated_CheckIfModsAreUpdated_Params params;
	params.WorldContext = WorldContext;
