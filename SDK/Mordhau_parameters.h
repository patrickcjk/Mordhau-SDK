...
{
	struct FTransform                                  CurrentHand;                                              // (Parm, IsPlainOldData)
	struct FTransform                                  TargetHand;                                               // (Parm, IsPlainOldData)
	float                                              ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Mordhau.MordhauGameInstance.GetNewSessionID
struct UMordhauGameInstance_GetNewSessionID_Params
{
	int                                                ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Mordhau.MordhauPlayerController.ClientSetPlayFabSession
struct AMordhauPlayerController_ClientSetPlayFabSession_Params
{
	struct FPlayFabSession                             InSession;                                                // (ConstParm, Parm, ReferenceParm)
};
