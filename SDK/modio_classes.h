...
// Class modio.CallbackProxy_CheckIfModsAreUpdated
// 0x0038 (0x0060 - 0x0028)
class UCallbackProxy_CheckIfModsAreUpdated : public UOnlineBlueprintCallProxyBase
{
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class modio.CallbackProxy_CheckIfModsAreUpdated");
		return ptr;
	}


	class UCallbackProxy_CheckIfModsAreUpdated* STATIC_CheckIfModsAreUpdated(class UObject* WorldContext, TArray<int> ModIds);
};
